...
# Fixed title for the HTML documentation.
# If not set, it defaults to "<project> v<release> documentation".
#
html_title = 'eProsima Documentation Hub'
...
latex_documents = [
    (master_doc, 'all-docs.tex', 'all-docs Documentation',
     'Miguel Barro', 'manual'),
]
...
man_pages = [
    (master_doc, 'all-docs', 'all-docs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'all-docs', 'all-docs Documentation',
     author, 'all-docs', 'One line description of project.',
     'Miscellaneous'),
]
